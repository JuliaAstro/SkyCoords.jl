...
There are currently eight supported coordinate systems. The following
...
- [`AltAzCoords`](@ref): Horizontal (altitude/azimuth) coordinates system, tied to an [`Observer`](@ref) location and time via an [`AltAzFrame`](@ref)
